...
class FaceMasker:
    KEY_FACIAL_FEATURES = ('nose_tip', 'chin')
    ...
    def _mask_face(self, face_landmark: dict):
        ...
        nose_point = nose_tip[len(nose_tip) * 2 // 4]
    ...
    def _save(self):
        ...
        new_face_path = path_splits[0] + '-inap-mask' + path_splits[1]
...
if __name__ == '__main__':
    #cli()
    image_path="/home/ee201814096/observations/experiements/data/inappropriate_mask"
